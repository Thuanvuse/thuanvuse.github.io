...
from PyQt6.QtWidgets import (
	QApplication, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QTableWidget, QTableWidgetItem, QComboBox, QSpinBox, QStackedWidget, QHeaderView, QInputDialog, QDialog, QTextEdit, QDialogButtonBox, QLineEdit, QMenu
)
...
class LienKetWorker(QThread):
	...
	def DangNhap(self,account, passwordf, f_id, proxy_string):
		...
		while attempts < 3:
			...
			# Tạo payload
			payload = {
			    "apikey": "c51dbdc1e582041bd6271b221d27213a",  # Thay bằng API key thực tế
			    "img": img_src,
	...
	def run(self):
		try:
			...
			if is_linked:
				...
				# proxy="103.133.110.241:22221:fcqu0l1y:fCqU0l1Y"
...
class MainWindow(QWidget):
	...
	def init_ui(self):
		...
		side_menu_widget.setStyleSheet("background-color: #2b2b2b;")
	...
	def show_context_menu(self, pos):
		...
		auto_link = menu.addAction("🚀 Tự động liên kết + lấy điểm")
		...
		run_all = menu.addAction("⚙️ Chạy tất cả")
		...
		check_proxy = menu.addAction("🌐 Kiểm tra proxy")
